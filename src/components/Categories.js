...
const Categories = () => {
  return (
    <div className="d-none d-md-block">
      <div className="categoryHeader">Categoriesssss</div>
      <div className="underline"></div>
      <div className="categories">
        <Category
          title="ML"
          img="https://images.unsplash.com/photo-1515704089429-fd06e6668458?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
        />
        <Category
          title="IOTT"
          img="https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
        />
